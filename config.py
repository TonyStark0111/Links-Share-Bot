...
DB_NAME = os.environ.get("DB_NAME", "LinksShareBot1")

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()] # dont change anything 
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @xeonflix</b>")
...
ABOUT_TXT = """<b>›› ᴄᴏᴍᴍᴜɴɪᴛʏ: <a href='https://t.me/xeonflix'>xᴇᴏɴꜰʟɪx</a>
<blockquote expandable>›› ᴏᴡɴᴇʀ: <a href='https://t.me/Xeonflixadmin'>Cʟɪᴄᴋ ʜᴇʀᴇ​</a>
›› ʟᴀɴɢᴜᴀɢᴇ: <a href='https://docs.python.org/3/'>Pʏᴛʜᴏɴ 3</a>
›› ʟɪʙʀᴀʀʏ: <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ ᴠ2</a>
›› ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com/docs/'>Mᴏɴɢᴏ ᴅʙ</b></blockquote>""" # Bhosdiwalo agar developer me Yato ka username hataya to agli baar se koi repo public nhi krunga!!

CHANNELS_TXT = """<b>›› ᴍᴏᴠɪᴇs: <a href='https://t.me/CineFlixSaga'>ᴄɪɴᴇꜰʟɪx ꜱᴀɢᴀ</a>
<blockquote expandable>›› ᴡᴇʙsᴇʀɪᴇs: <a href='https://t.me/SeriesFlixSaga'>ꜱᴇʀɪᴇꜱꜰʟɪx ꜱᴀɢᴀ</a>
...
›› ᴄᴏᴍᴍᴜɴɪᴛʏ: <a href='https://t.me/xeonflix'>xᴇᴏɴꜰʟɪx</a>
